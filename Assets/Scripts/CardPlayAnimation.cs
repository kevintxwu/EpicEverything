...
public class CardPlayAnimation : MonoBehaviour {
    ...
    IEnumerator FadeCard() {
        ...
        while (opacity > 0.01) {
			...
			attack.faceColor = new Color32(255, 255, 255, byteOpacity);
			attack.outlineColor = new Color32(0, 0, 0, byteOpacity);
			health.faceColor = new Color32(255, 255, 255, byteOpacity);
			health.outlineColor = new Color32(0, 0, 0, byteOpacity);
			cost.faceColor = new Color32(255, 255, 255, byteOpacity);
			cost.outlineColor = new Color32(0, 0, 0, byteOpacity);
			time.faceColor = new Color32(255, 255, 255, byteOpacity);
			time.outlineColor = new Color32(0, 0, 0, byteOpacity);
